cask "micyou" do
  ...
  on_arm do
    url "https://github.com/LanRhyme/MicYou/releases/download/v1.3.5/MicYou-macOS-1.3.5-arm64.dmg"
  end

  on_intel do
    url "https://github.com/LanRhyme/MicYou/releases/download/v1.3.5/MicYou-macOS-1.3.5-x64.dmg"
  end
