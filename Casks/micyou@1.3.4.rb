cask "micyou@1.3.4" do
  ...
  on_arm do
    ...
    sha256 "dbbe60a7cd55b73d46ffff99aebb3599522c7fac41aba80c410f393fe73dffec"
  end

  on_intel do
    url "https://github.com/LanRhyme/MicYou/releases/download/v#{version}/MicYou-macOS-#{version}-x64.dmg",
        verified: "github.com/LanRhyme/MicYou/"
    sha256 "f5ed5526b8abe0ad750318d1719d32ef50a8ae64235d8f282754f582ec87952b"
  end
  name "MicYou"
